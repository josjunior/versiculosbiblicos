...
function funTagOne(){
    ...
    const versiculosFive = "Salmos 107:1 - Deem graças ao Senhor porque ele é bom; o seu amor dura para sempre.";
    const versiculosSix = "Hebreus 13:15 - Por meio de Jesus, portanto, ofereçamos continuamente a Deus um sacrifício de louvor, que é fruto de lábios que confessam o seu nome.";
    const versiculosSeven = "Colossenses 3:17 - Tudo o que fizerem, seja em palavra seja em ação, façam-no em nome do Senhor Jesus, dando por meio dele graças a Deus Pai.";
    const versiculosEight = "Efésios 5:20 - Dando graças constantemente a Deus Pai por todas as coisas, em nome de nosso Senhor Jesus Cristo.";
    const versiculosNine = "Salmos 7:17 - Darei graças ao Senhor por sua justiça; ao nome do Senhor Altíssimo cantarei louvores.";
    ...
    document.getElementById("divfive").innerHTML = versiculosFive;
    document.getElementById("divsix").innerHTML = versiculosSix;
    document.getElementById("divseven").innerHTML = versiculosSeven;
    document.getElementById("diveight").innerHTML = versiculosEight;
    document.getElementById("divnine").innerHTML = versiculosNine;
    document.getElementById("divteen").innerHTML = versiculosTeen;  
    document.getElementById("diveleven").innerHTML = versiculosEleven;  
    document.getElementById("divtwelve").innerHTML = versiculosTwelve;  
    document.getElementById("nav").style.width = "0";
}
function funTagTwo(){
    document.getElementById("tagalert").style.display = "block";
    ...
    const versiculosFour = "Mateus 28:19-20 - Portanto, vão e façam discípulos de todas as nações, batizando-os em nome do Pai e do Filho e do Espírito Santo, ensinando-os a obedecer a tudo o que eu lhes ordenei. E eu estarei sempre com vocês, até o fim dos tempos.";
    const versiculosFive = "1 Coríntios 1:30 - E por causa dele estais em Cristo Jesus, que se tornou para nós sabedoria de Deus, justiça, santificação e redenção.";
    const versiculosSix = "João 14:6 - Respondeu Jesus: Eu sou o caminho, a verdade e a vida. Ninguém vem ao Pai, a não ser por mim.";
    const versiculosSeven = "1 Timóteo 1:17 - Ao Rei eterno, o Deus único, imortal e invisível, sejam honra e glória para todo o sempre. Amém.";
    const versiculosEight = "Apocalipse 5:12 - Digno é o Cordeiro que foi morto de receber poder, riqueza, sabedoria, força, honra, glória e louvor!";
    const versiculosNine = "Salmo 119:105 - Lâmpada para os meus pés é a tua palavra e, luz para o meu caminho.";
    const versiculosTeen = "1 Timóteo 4:4-5 - Pois tudo o que Deus criou é bom, e nada deve ser rejeitado, se for recebido com ação de graças, pois é santificado pela palavra de Deus e pela oração.";
    const versiculosEleven = "1 Crônicas 16:29 - Deem ao Senhor a glória devida ao seu nome. Tragam ofertas e venham à sua presença. Adorem o Senhor no esplendor da sua santidade";
    const versiculosTwelve = "2 Samuel 22:47 - O Senhor vive! Bendita seja a minha Rocha! Exaltado seja Deus, a Rocha que me salva!";
